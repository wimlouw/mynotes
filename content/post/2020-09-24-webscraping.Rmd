...
I write another function, which will create a tibble[^14] for every job post, with the information I want. I can then put this into a list of tibbles using a for loop. 
