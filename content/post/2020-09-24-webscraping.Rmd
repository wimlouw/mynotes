...
I write another function, which will create a tibble[^14] for a job post, with the information I want. I can then use a for loop to apply the function to each job post and to put the result into a list of tibbles.
