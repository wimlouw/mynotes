  ...
  - ["Note-writing systems"](https://notes.andymatuschak.org/%C2%A7Note-writing_systems) — [Andy Matuschak](https://andymatuschak.org/) took me down this path....
   - [Roam Research](https://roamresearch.com/) --- "A note-taking tool for networked thought. As easy to use as a document. As powerful as a graph database." Non-linear note-taking. I'm trying this out for daily writing/accumulating ideas[^2]
    - ["TiddlyWiki"](https://tiddlywiki.com/) --- "...a unique non-linear notebook for capturing, organising and sharing complex information."
      - [Stroll](https://giffmex.org/experiments/stroll.experiment.html) --- open-source "Roam-like" experience. I'm currently using Stroll. Roam is really cool, but I have mixed feelings about it
