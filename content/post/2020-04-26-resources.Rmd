...
- "Non-linear" note-taking
  - [Note-taking | Wikipedia](https://en.wikipedia.org/wiki/Note-taking#Non-linear_note-taking)
  - ["Note-writing systems"](https://notes.andymatuschak.org/%C2%A7Note-writing_systems) --- Andy Matuschak
  - [Obsidian](https://obsidian.md/) --- I'm trying this out for daily writing/accumulating ideas[^2]. It's beautifully designed
  ...
  - [Org mode for Emacs – Your Life in Plain Text](https://orgmode.org/) --- this is a whole world in itself. See - ["The Plain Person’s Guide to Plain Text Social Science"](http://plain-text.co/) by Kieran Healy
 
---

## productivity rabbit hole

> ```¯\_(ツ)_/¯``` _a list of various "systems", "frameworks", "techniques"; metacognition, ["mindful productivity"](https://nesslabs.com/mindful-productivity), and the like (enter at own risk)_
...
- [Getting Things Done | Wikipedia](https://en.wikipedia.org/wiki/Getting_Things_Done) or "GTD" 
  - For a Trello implementation see "[The GTD Approach To Maximizing Productivity With Trello](https://blog.trello.com/gtd-getting-things-done-maximizing-productivity-trello)"
