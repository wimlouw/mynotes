...
*My personal "running list" of resources, tools, and random articles. Thinking about: Link highlighting (a bit busy) and organisation (some sections can be combined)*
...
-   See also: [The Hidden Curriculum](https://anchor.fm/hidden-curriculum) --- "[...] a podcast on all the topics you wanted to learn in (econ) graduate school. There are lots of things about the profession that you only hear if you have a great mentor or during networking opportunities. This podcast aims to help decrease that knowledge gap by bringing that information into your headphones."
...
-   See also the section on [note-taking](https://wimlouw.netlify.app/2020/09/24/resources/#taking-notes) below

[^1]: See also ["Find Work-Life Focus: A Trello Insider's Guide To Personal Productivity"](https://blog.trello.com/work-life-focus-trello-insider-guide-personal-productivity?hs_amp=true) and ["How To Become A Project Management Master With Trello"](https://blog.trello.com/project-management-power-ups). Btw, the [Gmail add-on](https://help.trello.com/article/1120-trello-for-gmail-add-on) is also v. useful
...
-   [SurveyCTO](https://www.surveycto.com/) --- "SurveyCTO is the most reliable, secure, and scalable mobile data collection platform for researchers and professionals working in offline settings."
    ...
    - See [SurveyCTO custom-plugin feature](https://www.surveycto.com/blog/field-plugins/)
...
- [TikZiT](https://tikzit.github.io/) — “TikZiT is a super simple GUI editor for graphs and string diagrams”
...
-   [The Not So Short Introduction to LATEX 2ε \| Tobias Oetiker, Hubert Partl, Irene Hyna and Elisabeth Schlegl](https://tobi.oetiker.ch/lshort/lshort.pdf)
...
-   [Visualizing with Text - 1st Edition - Richard Brath - Routledge Book](https://www.routledge.com/Visualizing-with-Text/Brath/p/book/9780367259266)[^2]
...
-   [Data visualization \| The Abdul Latif Jameel Poverty Action Lab](https://www.povertyactionlab.org/resource/data-visualization)
- [New visual libraries for R and Stata users](https://blogs.worldbank.org/impactevaluations/new-visual-libraries-r-and-stata-users) — WB DIME

[^2]: See also: [Visualizing with Text \| Richard Brath's blog](https://richardbrath.wordpress.com/books-and-chapters-by-richard-brath/visualizing-with-text-book-companion-web-site/) for interactive demos and code
...
-   R Markdown
    ...
    -   [knitcitations](https://github.com/cboettig/knitcitations) --- dynamic citations on R Markdown
      -   See also [here](https://wimlouw.netlify.app/2020/09/24/citations/) 
...
-   [Notion](https://www.notion.so/work) --- "The all-in-one workspace for your notes, tasks, wikis, and databases." See also [here](https://twitter.com/NotionHQ/status/1306677709263630336), Notion now has backlinks \<3
...
-   "Non-linear" note-taking --- backlinks, transclusion, &c.
    -   [Obsidian](https://obsidian.md/) --- "...an IDE for your notes."
...
-   Articles
    - [The Rise and Fall of Getting Things Done | The New Yorker \| Cal Newport](https://www.newyorker.com/tech/annals-of-technology/the-rise-and-fall-of-getting-things-done)
...
-   Books
    ...
    -   [Dan Charnas: Using Lessons From Great Chefs To Help Us 'Work Clean'](https://www.forbes.com/sites/shawnsetaro/2016/04/27/work-clean/#3c41e9e4fb20) --- *mise-en-place*
    -   [Atomic Habits: Tiny Changes, Remarkable Results \| James Clear](https://jamesclear.com/atomic-habits)
    -   [How to Take Smart Notes: One Simple Technique to Boost Writing, Learning and Thinking \| Sönke Ahrens](https://www.amazon.com/How-Take-Smart-Notes-Nonfiction-ebook/dp/B06WVYW33Y) --- Niklas Luhmann, the *zettelkasten*, &c.
...
-   Tools
    ...
    -   [Evergreen note-writing as fundamental unit of knowledge work \| Andy Matuschak](https://notes.andymatuschak.org/Evergreen_note-writing_as_fundamental_unit_of_knowledge_work) <3
-   Other
...
-   [Simple rules for concise scientific writing \| Limnology and Oceanography Letters - Wiley Online Library](https://aslopubs.onlinelibrary.wiley.com/doi/full/10.1002/lol2.10165) by Scott Hotaling
...
-   ["PRIMER", Chapter 4: Counterfactuals and Their Applications \| Judea Pearl, Madelyn Glymour, Nicholas P. Jewell](http://web.cs.ucla.edu/~kaoru/primer-ch4.pdf)
...
-   [The death of the literature review and the rise of the dynamic knowledge map \| Impact of Social Sciences](https://blogs.lse.ac.uk/impactofsocialsciences/2019/05/14/the-death-of-the-literature-review-and-the-rise-of-the-dynamic-knowledge-map/) ---- hmmm
