...
-   [Visualizing with Text - 1st Edition - Richard Brath - Routledge Book](https://www.routledge.com/Visualizing-with-Text/Brath/p/book/9780367259266)

    -   See also: [Visualizing with Text \| Richard Brath's blog](https://richardbrath.wordpress.com/books-and-chapters-by-richard-brath/visualizing-with-text-book-companion-web-site/) for interactive demos and code
...
-   [Install RStudio UI](https://www.rstudio.com/products/rstudio/download/) (highly recommended)[^2]
