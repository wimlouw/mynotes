...
- [RemNote](https://www.remnote.io/homepage) --- "RemNote is the first spaced-repetition powered note-taking tool that lets you structure knowledge exactly in the way you think about it."
- [Roam Research](https://roamresearch.com/) --- "A note-taking tool for networked thought. As easy to use as a document. As powerful as a graph database." Non-linear note-taking. I use this for daily writing and specifically for accumulating ideas[^2]
  - See other non-linear note taking tools: TiddlyWiki ("Stroll"), RemNote, Obsidian. I'm currently using Stroll 
...
> ```¯\_(ツ)_/¯``` _a list on various "systems", "frameworks", "techniques"; metacognition, ["mindful productivity"](https://nesslabs.com/mindful-productivity), and the like (enter at own risk)_

- [Getting Things Done | Wikipedia](https://en.wikipedia.org/wiki/Getting_Things_Done) or "GTD." For a Trello implementation see "[The GTD Approach To Maximizing Productivity With Trello](https://blog.trello.com/gtd-getting-things-done-maximizing-productivity-trello)"
...
- [How to Take Smart Notes: One Simple Technique to Boost Writing, Learning and Thinking | Sönke Ahrens ](https://www.amazon.com/How-Take-Smart-Notes-Nonfiction-ebook/dp/B06WVYW33Y) --- Niklas Luhmann, the "slip-box" or _zettelkasten_, &c.
- [Evergreen note-writing as fundamental unit of knowledge work | Andy Matuschak](https://notes.andymatuschak.org/About_these_notes?stackedNotes=z3SjnvsB5aR2ddsycyXofbYR7fCxo7RmKW2be) --- intrigued by most of Andy Matuschak's [ideas](https://andymatuschak.org/)
- [“Responsibility assignment matrix" | Wikipedia](https://en.wikipedia.org/wiki/Responsibility_assignment_matrix) --- "RACI" charts
- [“Why Google Sheets Should Be Your To-Do List” | Zapier Blog](https://zapier.com/blog/google-sheets-to-do-list/?utm_source=Iterable&utm_medium=email&utm_campaign=itbl-gbl-eng-email-blog_keep_track_of_anything_automatically_1150346) --- could be! 
-  [One-Touch to Inbox Zero: How I Spend 17 Minutes Per Day on Email - Forte Labs](https://fortelabs.co/blog/one-touch-to-inbox-zero/) --- this feels a bit fast to me, tbh.[^3]
- [How to Do Nothing: Resisting the Attention Economy | Jenny  Odell](https://www.amazon.com/How-Do-Nothing-Resisting-Attention/dp/1612197493)
...
- [Time management - HBR](https://hbr.org/topic/time-management)
...
- [Install RStudio UI](https://www.rstudio.com/products/rstudio/download/) (highly recommended)[^4]
...
[^3]: See [Triage strategies for maintaining inboxes (e.g. Inbox Zero) are often too brittle | Andy Matuschak](https://notes.andymatuschak.org/z8aZybuJJopS5fL7TnPou2JcmCsBUJeqirbBh)
[^4]: I <3 the [styler](https://github.com/r-lib/styler) and [datapasta](https://github.com/MilesMcBain/datapasta) and [littleboxes](https://github.com/ThinkR-open/littleboxes) RStudio add-ins! Here's a post I saw on some others: ["RStudio addins, or how to make your coding life easier"](https://www.statsandr.com/blog/rstudio-addins-or-how-to-make-your-coding-life-easier/)
