...
## workflow
- [Good enough practices in scientific computing | Greg Wilson, Jennifer Bryan, and others](http://journals.plos.org/ploscompbiol/article?id=10.1371/journal.pcbi.1005510){target="_blank"}
...
- [RMarkdown Driven Development | Emily Riederer](https://emilyriederer.netlify.com/post/rmarkdown-driven-development/){target="_blank"}
...
- [The Plain Person’s Guide to Plain Text Social Science | Kieran Healy](http://plain-text.co/){target="_blank"}
...
- [Shape Up | Basecamp](https://basecamp.com/shapeup){target="_blank"}
